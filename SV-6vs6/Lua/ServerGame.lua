...
ServerGame.GuildWelfare= {
	overdue_time = 1206900,						--Reward timeout: 14 days
}
--【改动任何内容都请单独改动每个分支下的配置文件条目，禁止偷懒直接将整个文件从一个分支复制到另外一个分支！】
--【配置表下按类别拆分，新内容如有必要则按格式重建一个配置表单独对应！】
...
ServerGame.Item = {
  ...
  machine_mount = {25400,25401,901549,905330,906440,906442},       --------所有机甲
}
...
[17] = 2,
  ...
  Linkage = {
   {type=1,year=2023,month=6,end_time="2025-11-30 5:00:00"},
  }--联动扭蛋关闭时间
}
...
ServerGame.MvpScore = {
  ...
  showNames = {
    top1damage = {name="TOP 1 Damage", show_order=1},
    damage = {name="Damage", show_order=2},
    belock = {name="Belock",show_order=3},
    heal = {name="Heal", show_order=4},
    rebirth = {name="Rebirth", show_order=5},
    deadhit ={name="Deadhit", show_order=6},
    firsthit = {name="Firsthit", show_order=7},
    breakskill = {name="Breakskill", show_order=8},
  }
}
...
--Land of Prophecy recharge deadline
...
ServerGame.Altman = {
  ...
  --kill_reward = {{num=30,rewardid=12110},{num=60,rewardid=12111},{num=90,rewardid=12112},{num=120,rewardid=12113}}, --กรอกอีเมล์ID
  ...
  -- Ultraman dungeon monster killing level description
  kill_rank_desc = {
    [1] = { title = "Commander Nebula", killcount = 120 },
    [2] = { title = "Alien Monitor", killcount = 90 },
    [3] = { title = "Stellar Inspector", killcount = 60 },
    [4] = { title = "Planetary Patroller", killcount = 30 },
  },
}
